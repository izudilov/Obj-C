...
int main(int argc, const char * argv[]) {
  ...
  // Lesson-6------------------------------------------------------------------------
        ...
        Block sum = ^(NSInteger a, NSInteger b) {
            return a + b;
        };

        Block sub = ^(NSInteger a, NSInteger b) {
            return a - b;
        };

        Block mult = ^(NSInteger a, NSInteger b) {
            return a * b;
        };

        Block div = ^(NSInteger a, NSInteger b) {
            return a / b;

        };
        
        Block sumAndSub = ^(NSInteger a, NSInteger b) {
            return a + b - b;

        };
        
        Block multAndDiv = ^(NSInteger a, NSInteger b) {
            return a * b / a;

        };


        NSLog(@"Sum = %li", (long)[Calculator2 newCalculate: firstNumber with: secondNumber withBlock: sum]);
        NSLog(@"Sub = %li", (long)[Calculator2 newCalculate: firstNumber with: secondNumber withBlock: sub]);
        NSLog(@"Mult = %li", (long)[Calculator2 newCalculate: firstNumber with: secondNumber withBlock: mult]);
        NSLog(@"Div = %li", (long)[Calculator2 newCalculate: firstNumber with: secondNumber withBlock: div]);
        NSLog(@"Sum and Sub = %li", (long)[Calculator2 newCalculate: firstNumber with: secondNumber withBlock: sumAndSub]);
        NSLog(@"Mult and Div = %li", (long)[Calculator2 newCalculate: firstNumber with: secondNumber withBlock: multAndDiv]);
        ...
        NSBlockOperation *resultOperation = [NSBlockOperation blockOperationWithBlock:^{
        ...
        [resultOperation addDependency: thirdOperation];
        [myQueue addOperation: firstOperation];
        [myQueue addOperation: secondOperation];
        [myQueue addOperation: thirdOperation];
        [myQueue waitUntilAllOperationsAreFinished];
        [myQueue addOperation: resultOperation];
